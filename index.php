	...
	<body id="top">
		...
		<!-- Header -->
			<header id="header">
				...
				<h1><strong>Franco Mondino</strong>, Antani vicesindaco<br />
				from brematurata's things<br />
				in <a href="#">Bergamo</a>.</h1>
			</header>
...
print 'It took ' + i + ' iterations to sort the deck.';</code></pre>
		...
		<!-- Footer -->
			<footer id="footer">
				<ul class="icons">
					<li><a href="https://twitter.com/mondino_franco" class="icon fa-twitter"><span class="label">Twitter</span></a></li>
					<li><a href="mailto:mail@francomondino.it" class="icon fa-envelope-o"><span class="label">Email</span></a></li>
				</ul>
				<ul class="copyright">
					<li>&copy; Franco Mondino</li><li>Design: <a href="http://html5up.net">HTML5 UP</a></li>
				</ul>
			</footer>
